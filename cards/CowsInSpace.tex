...
\begin{center}
    {\captionfontsize \textsf{\textbf{FORCE FIELD}}}\end{center}
        {\textfontsize Cows may turn their surrounding hexes into blockades.}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
        {\quotefontsize \textit{}}\\[-2\baselineskip]
    };
    \node[circle,draw,text=black](c) at (.5,\cardheight-.5){};
...
\begin{center}
    {\captionfontsize \textsf{\textbf{TARGET TURNER}}}\end{center}
        {\textfontsize Any number of targets may be rotated to a new position for a turn.}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
        {\quotefontsize \textit{}}\\[-2\baselineskip]
    };
    \node[circle,draw,text=black](c) at (.5,\cardheight-.5){};
...
\begin{tikzpicture}
    ...
    \begin{center} {\fontsize{80pt}{60pt}\selectfont \COW}\\\end{center}
\begin{center}
    {\captionfontsize \textsf{\textbf{PARTICLE WAVE DUALITY}}}\end{center}
        {\textfontsize A cow may stop if any of the side diagonals are blocked.}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
        {\quotefontsize \textit{}}\\[-2\baselineskip]
    };
    \node[circle,draw,text=black](c) at (.5,\cardheight-.5){};
...
\begin{tikzpicture}
    ...
    \begin{center} {\fontsize{80pt}{60pt}\selectfont \COW}\\\end{center}
\begin{center}
    {\captionfontsize \textsf{\textbf{SPACE CURVATURE}}}\end{center}
        {\textfontsize Outer walls are removed. Cows moving into a wall wrap to the opposite side of the board and continue moving.}
        \tikz{\fill (0,0) rectangle (\cardwidth-2*\strippadding-2*\textpadding,\ruleheight);}\\
        {\quotefontsize \textit{}}\\[-2\baselineskip]
    };
    \node[circle,draw,text=black](c) at (.5,\cardheight-.5){};
...
\begin{tikzpicture}
    ...
    \begin{center} {\fontsize{80pt}{60pt}\selectfont \COW}\\\end{center}
\begin{center}
    {\captionfontsize \textsf{\textbf{ACTION AT A DISTANCE}}}\end{center}
